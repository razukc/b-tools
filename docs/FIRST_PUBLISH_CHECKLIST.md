...
This checklist will guide you through publishing extn to npm for the first time.
...
- [ ] Is the package name `extn` available on npm? (Check: https://www.npmjs.com/package/extn)
...
### 3. Repository Status
- [ ] Is the GitHub repository `razukc/extn` created?
...
# This creates extn-0.1.0.tgz
# Install it globally to test
npm install -g ./extn-0.1.0.tgz
...
git commit -m "feat: initial release of extn
...
# Verify on GitHub
# Visit: https://github.com/razukc/extn
```
...
Visit: https://www.npmjs.com/package/extn
...
Visit: https://github.com/razukc/extn/releases
...
# 2. Use a scoped package: @razukc/extn
```
...
- ✅ Package is visible on npm: https://www.npmjs.com/package/extn
- ✅ GitHub release exists: https://github.com/razukc/extn/releases/tag/v0.1.0
- ✅ Can install globally: `npm install -g extn`
- ✅ CLI works: `extn --version`
- ✅ Can create projects: `extn create test`
